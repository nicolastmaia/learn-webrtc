...
type CallAnswerProps = { height?: number; width?: number; fill?: string };

const CallAnswer = (props: CallAnswerProps): JSX.Element => (
  <Svg width={66.667} height={66.667} viewBox="0 0 50 50" {...props}>
